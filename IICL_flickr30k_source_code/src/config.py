...
def get_args():
    ...
    parser.add_argument('--n_epochs', type=int, default=100,   #100->50
                        help='Maximum number of epochs.')
    parser.add_argument('--tf_n_heads', type=int, default=8,
                        help='Number of attention heads in Transformer models.')
    parser.add_argument('--tf_n_layers', type=int, default=4,
    ...
    parser.add_argument('--recipe_loss_weight', type=float, default=0.0,   # first:1.0->0.0
                        help='Weight value for the loss computed on recipe-only samples.')

    #########
    parser.add_argument('--intraCL_loss_weight', type=float, default=0.01,
                        help='Weight value for the overall intra CL loss.')
    parser.add_argument('--intraCL_title_ingrs_loss_weight', type=float, default=1.0,
                        help='Weight value for the intra title ingrs CL loss.')
    parser.add_argument('--intraCL_title_instrs_loss_weight', type=float, default=1.0,
                        help='Weight value for the intra title instrs CL loss.')
    parser.add_argument('--intraCL_title_recipe_loss_weight', type=float, default=1.0,
                        help='Weight value for the intra title recipe CL loss.')
    parser.add_argument('--intraCL_ingrs_instrs_loss_weight', type=float, default=1.0,
                        help='Weight value for the intra ingrs instrs CL loss.')
    parser.add_argument('--intraCL_ingrs_recipe_loss_weight', type=float, default=1.0,
                        help='Weight value for the intra ingrs recipe CL loss.')
    parser.add_argument('--intraCL_instrs_recipe_loss_weight', type=float, default=1.0,
                        help='Weight value for the intra instrs recipe CL loss.')

    parser.add_argument('--interCL_loss_weight', type=float, default=0.01,
                        help='Weight value for the overall inter CL loss.')
    parser.add_argument('--titleCL_loss_weight', type=float, default=1.0,
                        help='Weight value for the loss computed on title CL.')
    parser.add_argument('--ingrsCL_loss_weight', type=float, default=1.0,
                        help='Weight value for the loss computed on ingredients CL.')
    parser.add_argument('--instrsCL_loss_weight', type=float, default=1.0,
                        help='Weight value for the loss computed on instructions CL.')
    parser.add_argument('--recipeCL_loss_weight', type=float, default=1.0,
                        help='Weight value for the loss computed on recipe CL.')

    parser.add_argument('--log_dir', type=str, default=None,
                        help='log file save path.')
    

    parser.add_argument('--training_data_comb', type=str, default="123",
                        help='different comb of training data.')
    ########


    parser.add_argument('--batch_size', type=int, default=64, help='Batch size.')   # 128->64
